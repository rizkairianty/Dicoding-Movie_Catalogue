...
public class SearchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvCategory = (RecyclerView) view.findViewById(R.id.rv_search);
    ...
    public void loadData() {
        ...
        progressDialog.show();
        String searchTitle = getArguments().getString(EXTRA_MOVIE);
        String API_URL = "https://api.themoviedb.org/3/search/movie?api_key="+BuildConfig.ApiKey+"&language=en-US&query="+searchTitle;
