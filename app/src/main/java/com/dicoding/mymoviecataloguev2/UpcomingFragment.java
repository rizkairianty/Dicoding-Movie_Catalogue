...
public class UpcomingFragment extends Fragment {
    ...
    private static final String API_URL = "https://api.themoviedb.org/3/movie/upcoming?api_key="+BuildConfig.ApiKey+"&language=en-US";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvCategory = (RecyclerView) view.findViewById(R.id.rv_upcoming);
